...
getDocs(emailQuery)
  .then((emailQuerySnapshot) => {
    ...
    addDoc(collection(db, "instructor"), values)
      .then((docRef) => {
      ...
      <form action="#">
          <div className="user-details">
            ...
            <div className="input-box">   
                  ...
                  <input type="text" name="Password Again" placeholder="Password Again" onChange={(event) =>
           ...
           <div className="input-box">
                    ...
                    <input type="text" name="Degree" placeholder="Degree" onChange={(event) =>
                ...
                <div className="input-box">
                  ...
                  <input type="text" name="Expertise" placeholder="Expertise" onChange={(event) =>
                    setValues((prev) => ({ ...prev, expertise: event.target.value }))
                  }/>
              ...
              <div className="input-box">
                  ...
                  <input type="text" name="Mobile No" placeholder="Mobile No" onChange={(event) =>
              ...
              <div className="input-box">
                  ...
                  <div>
                    <Select options={options}  placeholder="select your choice" onChange={(selectedOption) => {
